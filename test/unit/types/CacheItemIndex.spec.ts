...
describe("CacheItemIndex", ()=>{
    it("compare", () => {
        let itemIndexA = new CacheItemIndex("A", 1673519400); // expire first
        let itemIndexB = new CacheItemIndex("B", 1673519500);
        expect(itemIndexA.compare(itemIndexB) < 0).toBeTruthy();
        let itemIndexC = new CacheItemIndex("A", 1673519400);
    ...
    it("heap with orderByExpiredTSScoreFunction", () => {
        ...
        heap.insert(new CacheItemIndex("A", 1673519500)); // 1
        heap.insert(new CacheItemIndex("B", 1673519600)); // 3
        heap.insert(new CacheItemIndex("C", 1673519500)); // 2
